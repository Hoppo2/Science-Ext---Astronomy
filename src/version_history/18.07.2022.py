...
class Environment(_COMBO_Data):
    ...
    def average_maj_min_axis(self, equal_var=False):
        ...
        a_majaxis_values = []
        for i in self.Mcz_prop:
            if self.a_min_z < i[0] < self.a_max_z and not np.isnan(i[4]):
            if self.a_min_z < i[0] < self.a_max_z:
                a_minaxis_values.append(i[4])
        for i in self.Mcz_prop:
            if self.a_min_z < i[0] < self.a_max_z and not np.isnan(i[5]):
            if self.a_min_z < i[0] < self.a_max_z:
        ...
        if self.b_min_z is not None and self.b_max_z is not None:
            ...
            b_majaxis_values = []
            for i in self.Mcz_prop:
                if self.b_min_z < i[0] < self.b_max_z and not np.isnan(i[4]):
                if self.b_min_z < i[0] < self.b_max_z:
                    b_minaxis_values.append(i[4])
            for i in self.Mcz_prop:
                if self.b_min_z < i[0] < self.b_max_z and not np.isnan(i[5]):
                if self.b_min_z < i[0] < self.b_max_z:
...
if __name__ == "__main__":
    print(Environment([0.73197994, 0.77197994], [0.13862278, 0.17862278]).average_DL())
    print(Environment([0.13862278, 0.17862278], [0.83964487, 0.87964487]).average_DL())
    print(Environment([0.83964487, 0.87964487], [0.73197994, 0.77197994]).average_DL())
