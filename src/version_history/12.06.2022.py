...
class _Data:
    ...
    def __init__(self):
        ...
        self.Incl_Mcz = np.array(
            list(zip(self.data["Mcz"], self.data["W462FE"], self.data["W485FD"],
...
if __name__ == "__main__":
    Cluster().visualiser(model=Cluster().cluster_Incl_Mcz(n=6)[0])

    # print(ManualLabour().best_model(n_iterations=10000, n_clusters=4))
