...
class Environment(_COMBO_Data):
    ...
    def density_graph(self, bins: int = 0.002):
        ...
        ax1.scatter(x_values2_r, y_values2_u, color='violet', s=0.1)
        ax1.scatter(x_values2_r, y_values2_v, color='yellow', s=0.1)
        ax1.scatter(x_values2_r, y_values2_b, color='aqua', s=0.1)
